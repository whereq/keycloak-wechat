...
import com.whereq.keycloak.wechat.helpers.JsonHelper;
...
public class WeChatIdentityBrokerService implements IdentityProvider.AuthenticationCallback {
    ...
    public WeChatIdentityBrokerService(RealmModel realmModel) {
        if (realmModel == null) {

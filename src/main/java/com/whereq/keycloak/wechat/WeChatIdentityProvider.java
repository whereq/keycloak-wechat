...
import com.whereq.keycloak.wechat.egress.wechat.mp.WeChatMpApi;
import com.whereq.keycloak.wechat.egress.wechat.mp.models.ActionInfo;
import com.whereq.keycloak.wechat.egress.wechat.mp.models.Scene;
import com.whereq.keycloak.wechat.egress.wechat.mp.models.TicketRequest;
import com.whereq.keycloak.wechat.helpers.UserAgentHelper;
import com.whereq.keycloak.wechat.helpers.WMPHelper;
...
public class WeChatIdentityProvider extends AbstractOAuth2IdentityProvider<OAuth2IdentityProviderConfig>
    ...
    public final WeChatIdentityCustomAuth customAuth;
    ...
    public WeChatIdentityProvider(KeycloakSession session, OAuth2IdentityProviderConfig config) {
        ...
        customAuth = new WeChatIdentityCustomAuth(session, config, this);
    }
    ...
    protected class Endpoint {
        ...
        private Response authenticated(BrokeredIdentityContext federatedIdentity) {
            var weiXinIdentityBrokerService =
                    new WeChatIdentityBrokerService(realm);

...
import com.whereq.keycloak.wechat.AuthenticatedWMPSession;
import com.whereq.keycloak.wechat.WMPUserSessionModel;
import com.whereq.keycloak.wechat.WeChatIdentityBrokerService;
...
public class WMPHelper {
    ...
    public static ClientSessionCode getClientSessionCode(WeChatIdentityBrokerService weChatIdentityBrokerService, RealmModel realmModel, KeycloakSession session, BrokeredIdentityContext context) {
        ...
        final AuthenticatedWMPSession wmpSession = new AuthenticatedWMPSession(session, weChatIdentityBrokerService.realmModel, userModel);

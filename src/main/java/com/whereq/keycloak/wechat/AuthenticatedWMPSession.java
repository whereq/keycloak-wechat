...
public class AuthenticatedWMPSession implements AuthenticationSessionModel {
    ...
    public String getAuthNote(String s) {
        ...
        if (s.equals(WeChatIdentityBrokerService.LINKING_IDENTITY_PROVIDER)) {
            System.out.println("getauthnote for " + WeChatIdentityBrokerService.LINKING_IDENTITY_PROVIDER + "; returned Boolean null");
            return null;
        }
